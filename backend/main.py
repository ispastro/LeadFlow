...
from app.api import chat, leads, health, knowledge, analytics, conversations, auth, knowledge_mgmt
...
app.include_router(knowledge_mgmt.router, prefix="/api", tags=["Knowledge Management"])
